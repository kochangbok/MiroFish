...
def get_report_progress(report_id: str):
    ...
    try:
        ...
        if not progress:
            return jsonify({
                "success": False,
                "error": f"Report not found or progress is unavailable: {report_id}"
            }), 404
...
def stream_agent_log(report_id: str):
    ...
    try:
        ...
        logger.error(f"Failed to stream agent log: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def stream_console_log(report_id: str):
    ...
    try:
        ...
        logger.error(f"Failed to stream console log: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
